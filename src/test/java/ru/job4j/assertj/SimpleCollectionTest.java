...
class SimpleCollectionTest {
    ...
    void generalAssert() {
        ...
        assertThat(sc).isNotEmpty()
                ...
                /*содержит элементы:*/
                .contains(1, 5, 4)
                /*содержит это в любом пор€дке, дубликаты не важны:*/
                .containsOnly(1, 5, 4, 3)
                /*содержит только это и только в указанном пор€дке:*/
                .containsExactly(1, 1, 3, 4, 5)
                /*содержит только это в любом пор€дке:*/
                .containsExactlyInAnyOrder(5, 1, 3, 4, 1)
                /*содержит хот€ бы один из:*/
                .containsAnyOf(200, 100, 3)
                /*не содержит ни одного из:*/
                .doesNotContain(0, 6)
                /*начинаетс€ с последовательности:*/
                .startsWith(1, 1)
                /*заканчиваетс€ на последовательность:*/
                .endsWith(4, 5)
    ...
    void satisfyAssert() {
        ...
        assertThat(sc).isNotNull()
                /*все элементы выполн€ют условие*/
                .allSatisfy(e -> {
                    assertThat(e).isLessThan(10);
                    assertThat(e).isGreaterThan(0);
                })
                /*хот€ бы один элемент выполн€ет условие*/
                .anySatisfy(e -> {
