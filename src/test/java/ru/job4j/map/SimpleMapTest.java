...
class SimpleMapTest {
    ...
    @Test
    void whenCheckPutOut() {
        assertThat(map.put(0, "0")).isTrue();
        assertThat(map.put(null, "123")).isFalse();
        assertThat(map.put(8, "123")).isFalse();
        assertThat(map.put(7, "123")).isTrue();
    }

    @Test
    void whenCheckPutNullNull() {
        assertThat(map.put(null, "123")).isTrue();
        assertThat(map.put(null, "123")).isFalse();
        assertThat(map.put(0, "0")).isFalse();
    }

    @Test
    void whenCheckPutNullGet0() {
        assertThat(map.put(null, "123")).isTrue();
        assertThat(map.put(null, "0000")).isFalse();
        assertThat(map.get(0)).isNull();
    }
    ...
    @Test
    void whenCheckPutRemoveGet0() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(1, "123")).isTrue();
