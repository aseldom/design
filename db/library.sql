...
create view show_students_Иван as
select b.name Произвение, a.name Автор, s.name Студент from authors as a
join books b on b.author_id = a.id
join orders o on b.id = o.book_id
join students s on s.id = o.student_id
where s.name like 'Иван%'
order by a.name;

select * from show_students_Иван;